 ...
 * 
 */
public class UInt8ArrayNeMethod extends NeMethodRunner {
	 ...
	 * @param name
	 */
	public UInt8ArrayNeMethod(NeObjectTypeHandler prototype, String name, int ordinal) {
	...
	public void run(NeBranch<?> branch, ByteInflow inflow, NeFunction function) throws IOException {
		...
		((UInt8ArrayNeFunction) function).run(arg);
	}
}
