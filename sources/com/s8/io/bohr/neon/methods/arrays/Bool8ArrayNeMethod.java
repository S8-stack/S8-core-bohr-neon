 ...
 * 
 */
public class Bool8ArrayNeMethod extends NeMethodRunner {
	 ...
	 * @param name
	 */
	public Bool8ArrayNeMethod(NeObjectTypeHandler prototype, String name, int ordinal) {
	...
	public void run(NeBranch<?> branch, ByteInflow inflow, NeFunction function) throws IOException {
		...
		((Bool8ArrayNeFunction) function).operate(arg);
	}
